...
<head>
  <title>Reeds &mdash; Deodorizer </title>
  <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <!-- <a href="{{ url('/') }}" class="js-logo-clone">Reeds ID</a> -->
                <img src="{{ asset('shopper') }}/images/logo5.png">
              </div>
            </div>
        ...
        <div class='container p-0 pt-3'>
          <div class='row'>
            <div class='col-md-4 col-sm-12 pt-3'>
              ...
              <p>Reeds HQ <br> Bandung <br> (022)7238816 <br> customercare@reeds.id</p>
            </div>
            <div class='col-md-4 col-sm-12 pt-3'>
              <h3>Follow Us On</h3>
              <ul class="list-unstyled">
                <li class="email"><a href="https://instagram.com/reeds.id">@reeds.id</a></li>
            ...
            <div class='col-md-4 col-sm-12 pt-3'>
              ...
              <div class='newsletter-form p-0'>
                <form action='#' method='post' id="email_subscribe" for="email_subscribe" class="footer-heading">
                  @csrf
